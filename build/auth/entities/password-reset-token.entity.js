...
let PasswordResetToken = class PasswordResetToken {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, user: { required: true, type: () => require("../../user/entities/user.entity").User }, token_hash: { required: true, type: () => String }, token_expiry: { required: true, type: () => Number } };
    }
};
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.password_reset_tokens, {
        onDelete: 'CASCADE',
        eager: true,
    }),
...
], PasswordResetToken.prototype, "token_expiry", void 0);
